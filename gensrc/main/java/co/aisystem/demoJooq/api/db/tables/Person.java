...
public class Person extends TableImpl<PersonRecord> {
    ...
    private static final long serialVersionUID = -1611670253;
    ...
    /**
     * The column <code>public.person.serial_number</code>.
     */
    public final TableField<PersonRecord, Long> SERIAL_NUMBER = createField("serial_number", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PERSON_PKEY, Indexes.PERSON_SERIAL_NUMBER_KEY);
    }
    ...
    public List<UniqueKey<PersonRecord>> getKeys() {
        return Arrays.<UniqueKey<PersonRecord>>asList(Keys.PERSON_PKEY, Keys.PERSON_SERIAL_NUMBER_KEY);
    }
